...
namespace XbTool.Serialization
{
    public static class ReadFunctions
    {
        ...
        public static BTL_Arts_Dr ReadBTL_Arts_Dr(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.DebugName = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 2));
            item.Caption = BitConverter.ToUInt16(file, itemOffset + 6);
            item.CondCap = BitConverter.ToUInt16(file, itemOffset + 8);
            item.TalentCap = BitConverter.ToUInt16(file, itemOffset + 10);
            item.Driver = file[itemOffset + 12];
            item.WpnType = file[itemOffset + 13];
            item.IrType = file[itemOffset + 14];
            item.Condition = file[itemOffset + 15];
            item.ActNo = file[itemOffset + 16];
            item.ActSpeed = file[itemOffset + 17];
            item.MoveRev = file[itemOffset + 18];
            item.LoopNum = file[itemOffset + 19];
            item.IKStNo = file[itemOffset + 20];
            item.IKStf = file[itemOffset + 21];
            item.IKEndNo = file[itemOffset + 22];
            item.IKEndf = file[itemOffset + 23];
            item.ArtsType = file[itemOffset + 24];
            item.ArtsBuff = file[itemOffset + 25];
            item.ArtsDeBuff = file[itemOffset + 26];
            item.AtrType = file[itemOffset + 27];
            item.Flag = file[itemOffset + 28];
            item.NextArts = BitConverter.ToUInt16(file, itemOffset + 29);
            item.Target = file[itemOffset + 31];
            item.Distance = BitConverter.ToUInt16(file, itemOffset + 32);
            item.Multi = file[itemOffset + 34];
            item.RangeType = file[itemOffset + 35];
            item.Radius = BitConverter.ToUInt16(file, itemOffset + 36);
            item.Length = BitConverter.ToUInt16(file, itemOffset + 38);
            ...
            item.MoveCancelFrm = file[itemOffset + 130];
            item.DmgMgn1 = BitConverter.ToUInt16(file, itemOffset + 131);
            item.DmgMgn2 = BitConverter.ToUInt16(file, itemOffset + 133);
            item.DmgMgn3 = BitConverter.ToUInt16(file, itemOffset + 135);
            item.DmgMgn4 = BitConverter.ToUInt16(file, itemOffset + 137);
            item.DmgMgn5 = BitConverter.ToUInt16(file, itemOffset + 139);
            item.DmgMgn6 = BitConverter.ToUInt16(file, itemOffset + 141);
            item.Recast1 = BitConverter.ToUInt16(file, itemOffset + 143);
            item.Recast2 = BitConverter.ToUInt16(file, itemOffset + 145);
            item.Recast3 = BitConverter.ToUInt16(file, itemOffset + 147);
            item.Recast4 = BitConverter.ToUInt16(file, itemOffset + 149);
            item.Recast5 = BitConverter.ToUInt16(file, itemOffset + 151);
            item.Recast6 = BitConverter.ToUInt16(file, itemOffset + 153);
            item.AtrNum = file[itemOffset + 155];
            item.Enhance1 = BitConverter.ToUInt16(file, itemOffset + 156);
            item.Enhance2 = BitConverter.ToUInt16(file, itemOffset + 158);
            item.Enhance3 = BitConverter.ToUInt16(file, itemOffset + 160);
            item.Enhance4 = BitConverter.ToUInt16(file, itemOffset + 162);
            item.Enhance5 = BitConverter.ToUInt16(file, itemOffset + 164);
            item.Enhance6 = BitConverter.ToUInt16(file, itemOffset + 166);
            item.ReleaseLv1 = file[itemOffset + 168];
            item.ReleaseLv2 = file[itemOffset + 169];
            item.ReleaseLv3 = file[itemOffset + 170];
            item.ReleaseLv4 = file[itemOffset + 171];
            item.ReleaseLv5 = file[itemOffset + 172];
            item.NeedWP2 = BitConverter.ToUInt16(file, itemOffset + 173);
            item.NeedWP3 = BitConverter.ToUInt16(file, itemOffset + 175);
            item.NeedWP4 = BitConverter.ToUInt16(file, itemOffset + 177);
            item.NeedWP5 = BitConverter.ToUInt16(file, itemOffset + 179);
            item.HitEff = BitConverter.ToUInt16(file, itemOffset + 181);
            item.VoiceNum = file[itemOffset + 183];
            item.VoiceNum2 = BitConverter.ToUInt16(file, itemOffset + 184);
            item.VoiceDelay = BitConverter.ToUInt16(file, itemOffset + 186);
            item.UI = BitConverter.ToUInt16(file, itemOffset + 188);
            item.Priority = file[itemOffset + 190];
            item.GravOffNum = file[itemOffset + 191];
            item.GravOffF = BitConverter.ToUInt16(file, itemOffset + 192);
            item.GravOnNum = file[itemOffset + 194];
            item.GravOnF = BitConverter.ToUInt16(file, itemOffset + 195);
        ...
        public static BTL_BallBreak ReadBTL_BallBreak(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.DamageRate2 = BitConverter.ToUInt16(file, itemOffset + 6);
            item.FBGauge2 = BitConverter.ToUInt16(file, itemOffset + 8);
            item.FBBonus2 = BitConverter.ToUInt16(file, itemOffset + 10);
            return item;
        }
        ...
        public static BTL_ChainAttackFull ReadBTL_ChainAttackFull(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Wpn90 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 76));
            item.Wpn91 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 80));
            item.Wpn92 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 84));
            item.Wpn93 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 88));
            item.Wpn94 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 92));
            item.Wpn95 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 96));
            item.Wpn96 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 100));
            item.Wpn97 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 104));
            item.Wpn98 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 108));
            return item;
        }
        ...
        public static BTL_ChBtl ReadBTL_ChBtl(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Wave = file[itemOffset + 8];
            item.Caption = BitConverter.ToUInt16(file, itemOffset + 9);
            item.MapJump = BitConverter.ToUInt16(file, itemOffset + 11);
            item.Weather = file[itemOffset + 13];
            item.Type = file[itemOffset + 14];
            item.NeedDefeat = BitConverter.ToUInt16(file, itemOffset + 15);
            item.MaxLevel = file[itemOffset + 17];
            item.MaxWpnRank = file[itemOffset + 18];
            item.WpnRevTable = BitConverter.ToUInt16(file, itemOffset + 19);
            item.TimeLimit = BitConverter.ToUInt16(file, itemOffset + 21);
            item.JoinNumber = file[itemOffset + 23];
            item.Driver1 = file[itemOffset + 24];
            item.Driver2 = file[itemOffset + 25];
            item.Driver3 = file[itemOffset + 26];
            item.NeedItem = BitConverter.ToUInt16(file, itemOffset + 27);
            item.Condition = BitConverter.ToUInt16(file, itemOffset + 29);
            item.ConditionCap = BitConverter.ToUInt16(file, itemOffset + 31);
            item.Condition2 = BitConverter.ToUInt16(file, itemOffset + 33);
            item.ConditionCap2 = BitConverter.ToUInt16(file, itemOffset + 35);
            item.Flag = file[itemOffset + 37];
            item.HideCondition = BitConverter.ToUInt16(file, itemOffset + 38);
            item.ClearReward = BitConverter.ToUInt16(file, itemOffset + 40);
            item.TresureSet1 = BitConverter.ToUInt16(file, itemOffset + 42);
            item.TresureSet2 = BitConverter.ToUInt16(file, itemOffset + 44);
            item.TresureSet3 = BitConverter.ToUInt16(file, itemOffset + 46);
            item.TresureNeed1 = BitConverter.ToUInt16(file, itemOffset + 48);
            item.TresureNeed2 = BitConverter.ToUInt16(file, itemOffset + 50);
            item.TresureNeed3 = BitConverter.ToUInt16(file, itemOffset + 52);
            item.TresureResource1 = BitConverter.ToUInt16(file, itemOffset + 54);
            item.TresureResource2 = BitConverter.ToUInt16(file, itemOffset + 56);
            item.TresureResource3 = BitConverter.ToUInt16(file, itemOffset + 58);
            item.Voice1 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 60));
            item.Voice2 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 64));
            item.Voice3 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 68));
            item.Voice4 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 72));
            item.Event = BitConverter.ToUInt16(file, itemOffset + 76);
        ...
        public static BTL_ChBtlRewardSet ReadBTL_ChBtlRewardSet(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.AppointItemNum = BitConverter.ToUInt16(file, itemOffset + 22);
            item.AppointItem2 = BitConverter.ToUInt16(file, itemOffset + 24);
            item.AppointItemNum2 = BitConverter.ToUInt16(file, itemOffset + 26);
            item.UpCategory1 = file[itemOffset + 28];
            item.UpCategory2 = file[itemOffset + 29];
            item.DownCategory1 = file[itemOffset + 30];
            item.DownCategory2 = file[itemOffset + 31];
            item.UpItemID1 = BitConverter.ToUInt16(file, itemOffset + 32);
            item.UpItemID2 = BitConverter.ToUInt16(file, itemOffset + 34);
            item.UpItemID3 = BitConverter.ToUInt16(file, itemOffset + 36);
            item.UpItemID4 = BitConverter.ToUInt16(file, itemOffset + 38);
            item.DownItemID1 = BitConverter.ToUInt16(file, itemOffset + 40);
            item.DownItemID2 = BitConverter.ToUInt16(file, itemOffset + 42);
            item.DownItemID3 = BitConverter.ToUInt16(file, itemOffset + 44);
            item.DownItemID4 = BitConverter.ToUInt16(file, itemOffset + 46);
            return item;
        }
        ...
        public static BTL_Circle ReadBTL_Circle(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.SubType = file[itemOffset + 4];
            item.SubParam = BitConverter.ToUInt16(file, itemOffset + 5);
            item.Target = file[itemOffset + 7];
            item.Interval = file[itemOffset + 8];
            item.Lifespan = BitConverter.ToUInt16(file, itemOffset + 9);
            item.Effect = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 11));
            return item;
        }
        ...
        public static BTL_Condition ReadBTL_Condition(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.FLD_CondID2 = BitConverter.ToUInt16(file, itemOffset + 4);
            item.Param02 = BitConverter.ToUInt16(file, itemOffset + 6);
            return item;
        }
        ...
        public static BTL_DifSetting ReadBTL_DifSetting(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.ConditionOri = BitConverter.ToUInt16(file, itemOffset + 16);
            item.ConditionIra = BitConverter.ToUInt16(file, itemOffset + 18);
            item.Flag = file[itemOffset + 20];
            item.Ori = (item.Flag & 1) != 0;
            item.Ira = (item.Flag & 2) != 0;
            return item;
        }
        ...
        public static BTL_ElementalCombo ReadBTL_ElementalCombo(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Route = file[itemOffset + 8];
            item.RouteIra = file[itemOffset + 9];
            item.PreCombo = file[itemOffset + 10];
            item.Range = file[itemOffset + 11];
            item.BaseTime = BitConverter.ToUInt16(file, itemOffset + 12);
            item.Reaction = file[itemOffset + 14];
            item.ReactionLv = file[itemOffset + 15];
            item.DD = BitConverter.ToUInt16(file, itemOffset + 16);
            item.Dot = BitConverter.ToUInt16(file, itemOffset + 18);
            item.Interval = BitConverter.ToUInt16(file, itemOffset + 20);
            item.DDEn = BitConverter.ToSingle(file, itemOffset + 22);
            item.DotEn = BitConverter.ToSingle(file, itemOffset + 26);
            item.DDf1 = BitConverter.ToUInt16(file, itemOffset + 30);
            item.DDf2 = BitConverter.ToUInt16(file, itemOffset + 32);
            item.DDf3 = BitConverter.ToUInt16(file, itemOffset + 34);
            item.DDf4 = BitConverter.ToUInt16(file, itemOffset + 36);
            item.DDf5 = BitConverter.ToUInt16(file, itemOffset + 38);
            item.DDf6 = BitConverter.ToUInt16(file, itemOffset + 40);
            item.DDf7 = BitConverter.ToUInt16(file, itemOffset + 42);
            item.DDf8 = BitConverter.ToUInt16(file, itemOffset + 44);
            item.DDf9 = BitConverter.ToUInt16(file, itemOffset + 46);
            item.DDf10 = BitConverter.ToUInt16(file, itemOffset + 48);
            item.DDf11 = BitConverter.ToUInt16(file, itemOffset + 50);
            item.DDf12 = BitConverter.ToUInt16(file, itemOffset + 52);
            item.DDf13 = BitConverter.ToUInt16(file, itemOffset + 54);
            item.DDf14 = BitConverter.ToUInt16(file, itemOffset + 56);
            item.DDf15 = BitConverter.ToUInt16(file, itemOffset + 58);
            item.DDf16 = BitConverter.ToUInt16(file, itemOffset + 60);
            item.DmgRt1 = file[itemOffset + 62];
            item.DmgRt2 = file[itemOffset + 63];
            item.DmgRt3 = file[itemOffset + 64];
            item.DmgRt4 = file[itemOffset + 65];
            item.DmgRt5 = file[itemOffset + 66];
            item.DmgRt6 = file[itemOffset + 67];
            item.DmgRt7 = file[itemOffset + 68];
            item.DmgRt8 = file[itemOffset + 69];
            item.DmgRt9 = file[itemOffset + 70];
            item.DmgRt10 = file[itemOffset + 71];
            item.DmgRt11 = file[itemOffset + 72];
            item.DmgRt12 = file[itemOffset + 73];
            item.DmgRt13 = file[itemOffset + 74];
            item.DmgRt14 = file[itemOffset + 75];
            item.DmgRt15 = file[itemOffset + 76];
            item.DmgRt16 = file[itemOffset + 77];
            item.ReAct1 = file[itemOffset + 78];
            item.ReAct2 = file[itemOffset + 79];
            item.ReAct3 = file[itemOffset + 80];
            item.ReAct4 = file[itemOffset + 81];
            item.ReAct5 = file[itemOffset + 82];
            item.ReAct6 = file[itemOffset + 83];
            item.ReAct7 = file[itemOffset + 84];
            item.ReAct8 = file[itemOffset + 85];
            item.ReAct9 = file[itemOffset + 86];
            item.ReAct10 = file[itemOffset + 87];
            item.ReAct11 = file[itemOffset + 88];
            item.ReAct12 = file[itemOffset + 89];
            item.ReAct13 = file[itemOffset + 90];
            item.ReAct14 = file[itemOffset + 91];
            item.ReAct15 = file[itemOffset + 92];
            item.ReAct16 = file[itemOffset + 93];
            item.Effect = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 94));
            item.SE = file[itemOffset + 98];
            item.NaID = file[itemOffset + 99];
            item.DamageRate = file[itemOffset + 100];
            item.FusionName1 = file[itemOffset + 101];
            item.FusionName2 = file[itemOffset + 102];
            item.FusionName3 = file[itemOffset + 103];
            item.FusionName4 = file[itemOffset + 104];
            item.Icon = BitConverter.ToUInt16(file, itemOffset + 105);
            item.NeedAtrNum = file[itemOffset + 107];
            return item;
        }
        ...
        public static BTL_EndEvent ReadBTL_EndEvent(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new BTL_EndEvent();
            item.Id = itemId;
            item.Condition = BitConverter.ToUInt16(file, itemOffset);
            item.StandDeadVoice = file[itemOffset + 2];
            item.StandBossID = BitConverter.ToUInt16(file, itemOffset + 3);
            item.StandState = file[itemOffset + 5];
            item.EnemyCall = file[itemOffset + 6];
            item.CallRadius = BitConverter.ToUInt16(file, itemOffset + 7);
            item.BlackOut = BitConverter.ToUInt16(file, itemOffset + 9);
            return item;
        }
        ...
        public static BTL_Enhance ReadBTL_Enhance(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Caption2 = BitConverter.ToUInt16(file, itemOffset + 12);
            return item;
        }
        ...
        public static BTL_HealPot ReadBTL_HealPot(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.HpRatioIra = file[itemOffset + 2];
            item.Category = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 3));
            return item;
        }
        ...
        public static BTL_Lv_Rev ReadBTL_Lv_Rev(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.ExpRevLow2 = BitConverter.ToUInt16(file, itemOffset + 4);
            item.DamageRevHigh = BitConverter.ToUInt16(file, itemOffset + 6);
            item.DamageRevLow = BitConverter.ToUInt16(file, itemOffset + 8);
            item.HitRevLow = BitConverter.ToUInt16(file, itemOffset + 10);
            item.ReactRevHigh = BitConverter.ToUInt16(file, itemOffset + 12);
            return item;
        }
        ...
        public static BTL_SpBtl ReadBTL_SpBtl(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new BTL_SpBtl();
            item.Id = itemId;
            item.ArrangeID = BitConverter.ToUInt16(file, itemOffset);
            item.Gun = BitConverter.ToUInt16(file, itemOffset + 2);
            item.Lance = BitConverter.ToUInt16(file, itemOffset + 4);
            item.DamageLV1 = BitConverter.ToUInt16(file, itemOffset + 6);
            item.DamageLV2 = BitConverter.ToUInt16(file, itemOffset + 8);
            item.DamageLV3 = BitConverter.ToUInt16(file, itemOffset + 10);
            item.DamageLV4 = BitConverter.ToUInt16(file, itemOffset + 12);
            item.GaugeLV1 = BitConverter.ToUInt16(file, itemOffset + 14);
            item.GaugeLV2 = BitConverter.ToUInt16(file, itemOffset + 16);
            item.GaugeLV3 = BitConverter.ToUInt16(file, itemOffset + 18);
            item.GaugeLV4 = BitConverter.ToUInt16(file, itemOffset + 20);
            item.GaugeBonus = BitConverter.ToUInt16(file, itemOffset + 22);
            item.DownLV1 = file[itemOffset + 24];
            item.DownLV2 = file[itemOffset + 25];
            item.DownLV3 = file[itemOffset + 26];
            item.DownLV4 = file[itemOffset + 27];
            item.ShotNumLV1 = file[itemOffset + 28];
            item.ShotNumLV2 = file[itemOffset + 29];
            item.ShotNumLV3 = file[itemOffset + 30];
            item.ShotNumLV4 = file[itemOffset + 31];
            item.ShotFrame = file[itemOffset + 32];
            return item;
        }

        public static BTL_SpBtlPos ReadBTL_SpBtlPos(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new BTL_SpBtlPos();
            item.Id = itemId;
            item.situation = file[itemOffset];
            item.camera = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 1));
            item.Wpos = BitConverter.ToUInt16(file, itemOffset + 5);
            item.Bpos = BitConverter.ToUInt16(file, itemOffset + 7);
            return item;
        }

        public static BTL_SpSkill ReadBTL_SpSkill(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new BTL_SpSkill();
            item.Id = itemId;
            item.AddTimeBC1 = BitConverter.ToSingle(file, itemOffset);
            item.AddTimeBC2 = BitConverter.ToSingle(file, itemOffset + 4);
            item.AddTimeBC3 = BitConverter.ToSingle(file, itemOffset + 8);
            item.AddTimeDC1 = BitConverter.ToSingle(file, itemOffset + 12);
            item.AddTimeDC2 = BitConverter.ToSingle(file, itemOffset + 16);
            item.AddTimeDC3 = BitConverter.ToSingle(file, itemOffset + 20);
            item.AddTimeDC4 = BitConverter.ToSingle(file, itemOffset + 24);
            item.AddTimeFC2 = BitConverter.ToSingle(file, itemOffset + 28);
            item.AddTimeFC3 = BitConverter.ToSingle(file, itemOffset + 32);
            item.AddTimeFC4 = BitConverter.ToSingle(file, itemOffset + 36);
            item.AddTimeFC5 = BitConverter.ToSingle(file, itemOffset + 40);
            item.AddTimeFC6 = BitConverter.ToSingle(file, itemOffset + 44);
            item.AddTimeFC7 = BitConverter.ToSingle(file, itemOffset + 48);
            item.AddTimeMax = BitConverter.ToUInt16(file, itemOffset + 52);
            item.AddTimeRe = BitConverter.ToSingle(file, itemOffset + 54);
            item.AddTimeDecrease = BitConverter.ToSingle(file, itemOffset + 58);
        ...
        public static CHR_Dr ReadCHR_Dr(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.FavoriteCategory1 = BitConverter.ToUInt16(file, itemOffset + 173);
            item.FavoriteItem1 = BitConverter.ToUInt16(file, itemOffset + 175);
            item.FavoriteCategory2 = BitConverter.ToUInt16(file, itemOffset + 177);
            item.FavoriteItem2 = BitConverter.ToUInt16(file, itemOffset + 179);
            item.CollisionId = BitConverter.ToUInt16(file, itemOffset + 181);
            item.EventAsset = BitConverter.ToUInt16(file, itemOffset + 183);
            item.RotateX = (sbyte)file[itemOffset + 185];
            item.RotateY = (sbyte)file[itemOffset + 186];
            item.RotateZ = (sbyte)file[itemOffset + 187];
            item.RotateDeg = (sbyte)file[itemOffset + 188];
            item.RotEffScale = BitConverter.ToUInt16(file, itemOffset + 189);
            item.CenterBone = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 191));
            item.CamBone = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 195));
            item.Personality = file[itemOffset + 199];
            item.IraParam = BitConverter.ToUInt16(file, itemOffset + 200);
            for (int i = 0, offset = itemOffset + 101; i < 36; i++, offset += 1)
            {
                item.WpnType[i] = file[offset];
            }
            for (int i = 0, offset = itemOffset + 137; i < 36; i++, offset += 1)
            {
        ...
        public static CHR_EnArrange ReadCHR_EnArrange(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Serious = (item.Flag & 524288) != 0;
            item.NoChgBtl = (item.Flag & 1048576) != 0;
            item.NoKasumi = (item.Flag & 2097152) != 0;
            return item;
        }
        ...
        public static CHR_Ir ReadCHR_Ir(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.SeDriver = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 10));
            item.SeBlade = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 14));
            item.TeamName = BitConverter.ToUInt16(file, itemOffset + 18);
            item.KizunaReward1 = BitConverter.ToUInt16(file, itemOffset + 20);
            item.KizunaReward2 = BitConverter.ToUInt16(file, itemOffset + 22);
        ...
        public static COL_CharList ReadCOL_CharList(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.X = BitConverter.ToInt16(file, itemOffset + 4);
            item.Y = BitConverter.ToInt16(file, itemOffset + 6);
            item.Z = BitConverter.ToInt16(file, itemOffset + 8);
            return item;
        }
        ...
        public static FLD_CollectionTable ReadFLD_CollectionTable(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.categoryName = BitConverter.ToUInt16(file, itemOffset + 27);
            item.ZoneID = BitConverter.ToUInt16(file, itemOffset + 29);
            return item;
        }
        ...
        public static FLD_EnemyWaveIra ReadFLD_EnemyWaveIra(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.ScenarioFlagMax = BitConverter.ToUInt16(file, itemOffset + 10);
            item.Condition = BitConverter.ToUInt16(file, itemOffset + 12);
            item.OP_Condition = BitConverter.ToUInt16(file, itemOffset + 14);
            item.POP_TIME = BitConverter.ToUInt32(file, itemOffset + 16);
            item.popWeather = file[itemOffset + 20];
            item.instanceMax = file[itemOffset + 21];
            item.onlyOnce = file[itemOffset + 22];
            item.gimmick = BitConverter.ToUInt16(file, itemOffset + 23);
            item.waitTime = BitConverter.ToUInt16(file, itemOffset + 25);
            item.nameRadius = BitConverter.ToUInt16(file, itemOffset + 27);
            item.offsetID = BitConverter.ToUInt16(file, itemOffset + 29);
            item.tgtMSG_ID = BitConverter.ToUInt16(file, itemOffset + 31);
            item.missMSG_ID = BitConverter.ToUInt16(file, itemOffset + 33);
            item.actionwindowID = BitConverter.ToUInt16(file, itemOffset + 35);
            item.sealedStonePopID = BitConverter.ToUInt16(file, itemOffset + 37);
            return item;
        }
        ...
        public static FLD_GravePopList ReadFLD_GravePopList(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.menuMapImage = BitConverter.ToUInt16(file, itemOffset + 8);
            return item;
        }
        ...
        public static FLD_MapGimmick ReadFLD_MapGimmick(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.menuMapImage_0 = BitConverter.ToUInt16(file, itemOffset + 113);
        ...
        public static FLD_QuestBattle ReadFLD_QuestBattle(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.TargetOff = file[itemOffset + 20];
            return item;
        }
        ...
        public static FLD_VoiceTable ReadFLD_VoiceTable(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Ira1 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 24));
            item.Ira2 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 28));
            item.Ira3 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 32));
            item.Ira4 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 36));
            item.Ira5 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 40));
            item.Ira6 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 44));
            item.Ira7 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 48));
            item.Ira8 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 52));
            item.Ira9 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 56));
            return item;
        }
        ...
        public static FLD_VoiceTableRare ReadFLD_VoiceTableRare(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.RareBlade44 = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 172));
            return item;
        }
        ...
        public static FLD_WeatherInfo ReadFLD_WeatherInfo(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.snd_ira = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 10));
            item.sndBegin = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 14));
            return item;
        }
        ...
        public static ITM_HanaAssist ReadITM_HanaAssist(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Blade = BitConverter.ToUInt16(file, itemOffset + 54);
            item.Model = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 56));
            item.JS = (item.Flag & 1) != 0;
            item.JK = (item.Flag & 2) != 0;
            item.JD = (item.Flag & 4) != 0;
            return item;
        ...
        public static ITM_OrbEquip ReadITM_OrbEquip(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Blade = BitConverter.ToUInt16(file, itemOffset + 47);
        ...
        public static ITM_PcEquip ReadITM_PcEquip(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.IraZone = BitConverter.ToUInt16(file, itemOffset + 40);
            item.IraZone2 = BitConverter.ToUInt16(file, itemOffset + 42);
            item.sortJP = BitConverter.ToUInt32(file, itemOffset + 44);
            item.sortGE = BitConverter.ToUInt32(file, itemOffset + 48);
            item.sortFR = BitConverter.ToUInt32(file, itemOffset + 52);
            item.sortSP = BitConverter.ToUInt32(file, itemOffset + 56);
            item.sortIT = BitConverter.ToUInt32(file, itemOffset + 60);
            item.sortGB = BitConverter.ToUInt32(file, itemOffset + 64);
            item.sortCN = BitConverter.ToUInt32(file, itemOffset + 68);
            item.sortTW = BitConverter.ToUInt32(file, itemOffset + 72);
            item.Driver = file[itemOffset + 76];
            item.Model = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 77));
            item.NoSell = (item.Flag & 1) != 0;
            ...
            item.EqPC10 = (item.Flag & 1024) != 0;
            item.EqPC11 = (item.Flag & 2048) != 0;
            item.EqPC12 = (item.Flag & 4096) != 0;
            return item;
        }
        ...
        public static ITM_PcWpnChip ReadITM_PcWpnChip(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.CreateWpn35 = BitConverter.ToUInt16(file, itemOffset + 75);
            item.CreateWpn36 = BitConverter.ToUInt16(file, itemOffset + 77);
            item.Price = BitConverter.ToUInt32(file, itemOffset + 79);
            item.PriceIra = BitConverter.ToUInt32(file, itemOffset + 83);
            item.Rarity = file[itemOffset + 87];
            item.Flag = file[itemOffset + 88];
            item.Zone = BitConverter.ToUInt16(file, itemOffset + 89);
            item.Zone2 = BitConverter.ToUInt16(file, itemOffset + 91);
            item.IraZone = BitConverter.ToUInt16(file, itemOffset + 93);
            item.IraZone2 = BitConverter.ToUInt16(file, itemOffset + 95);
            item.sortJP = BitConverter.ToUInt32(file, itemOffset + 97);
            item.sortGE = BitConverter.ToUInt32(file, itemOffset + 101);
            item.sortFR = BitConverter.ToUInt32(file, itemOffset + 105);
            item.sortSP = BitConverter.ToUInt32(file, itemOffset + 109);
            item.sortIT = BitConverter.ToUInt32(file, itemOffset + 113);
            item.sortGB = BitConverter.ToUInt32(file, itemOffset + 117);
            item.sortCN = BitConverter.ToUInt32(file, itemOffset + 121);
            item.sortTW = BitConverter.ToUInt32(file, itemOffset + 125);
            item.NoSell = (item.Flag & 1) != 0;
            return item;
        }
        ...
        public static ma40a_FLD_CollectionPopList Readma40a_FLD_CollectionPopList(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.menuMapImage = BitConverter.ToUInt16(file, itemOffset + 26);
            return item;
        }

        public static ma40a_FLD_EnemyPop Readma40a_FLD_EnemyPop(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new ma40a_FLD_EnemyPop();
            item.Id = itemId;
            item.name = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset));
            item.tagetpoint_name = BitConverter.ToUInt16(file, itemOffset + 4);
            item.QuestFlag = BitConverter.ToUInt16(file, itemOffset + 6);
            ...
            item.ene_priority = (item.flag & 1) != 0;
            item.pop_smn = (item.flag & 2) != 0;
            item.pop_smn2 = (item.flag & 4) != 0;
            item.pop_smn3 = (item.flag & 8) != 0;
            item.pop_smn4 = (item.flag & 16) != 0;
            item.popCloud = (item.flag & 32) != 0;
            return item;
        }
        ...
        public static ma40a_FLD_NpcPop Readma40a_FLD_NpcPop(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new ma40a_FLD_NpcPop();
            item.Id = itemId;
            item.name = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset));
            item.NpcID = BitConverter.ToUInt16(file, itemOffset + 4);
            item.ScenarioFlagMin = BitConverter.ToUInt16(file, itemOffset + 6);
            ...
            item.FSID3 = BitConverter.ToUInt16(file, itemOffset + 67);
            item.Talkable = (item.flag & 1) != 0;
            item.HITONOWAGET = (item.flag & 2) != 0;
            return item;
        }
        ...
        public static ma40a_FLD_TboxPop Readma40a_FLD_TboxPop(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.NoponBarrel = (item.flag & 4) != 0;
            return item;
        }
        ...
        public static ma41a_FLD_CollectionPopList Readma41a_FLD_CollectionPopList(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.rarity = file[itemOffset + 26];
            return item;
        }

        public static ma41a_FLD_TboxPop Readma41a_FLD_TboxPop(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new ma41a_FLD_TboxPop();
            item.Id = itemId;
            item.name = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset));
            item.RSC_ID = BitConverter.ToUInt16(file, itemOffset + 4);
            item.Condition = BitConverter.ToUInt16(file, itemOffset + 6);
            ...
            item.menuMapImage = BitConverter.ToUInt16(file, itemOffset + 60);
            item.Digflg = (item.flag & 1) != 0;
            item.NoponBarrel = (item.flag & 2) != 0;
            return item;
        }
        ...
        public static MNU_DriverInfo ReadMNU_DriverInfo(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_DriverInfo();
            item.Id = itemId;
        ...
        public static MNU_InputAct ReadMNU_InputAct(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.text5 = BitConverter.ToUInt16(file, itemOffset + 9);
            item.repeat = file[itemOffset + 11];
            return item;
        }
        ...
        public static MNU_MsgPopupTitle ReadMNU_MsgPopupTitle(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.name2 = BitConverter.ToUInt16(file, itemOffset + 6);
            item.name3 = BitConverter.ToUInt16(file, itemOffset + 8);
            return item;
        }
        ...
        public static MNU_NpcChange ReadMNU_NpcChange(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_NpcChange();
            item.Id = itemId;
            item.base_npc = BitConverter.ToUInt16(file, itemOffset);
            item.cond_a = BitConverter.ToUInt16(file, itemOffset + 2);
            item.npc_a = BitConverter.ToUInt16(file, itemOffset + 4);
            item.cond_b = BitConverter.ToUInt16(file, itemOffset + 6);
            item.npc_b = BitConverter.ToUInt16(file, itemOffset + 8);
            return item;
        }

        public static MNU_NpcFace ReadMNU_NpcFace(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_NpcFace();
            item.Id = itemId;
            item.base_npc = BitConverter.ToUInt16(file, itemOffset);
            return item;
        }
        ...
        public static MNU_ShopChangeNopon ReadMNU_ShopChangeNopon(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_ShopChangeNopon();
            item.Id = itemId;
            item.TaskSet = BitConverter.ToUInt16(file, itemOffset);
            item.Condition = BitConverter.ToUInt16(file, itemOffset + 2);
            item.Condition2 = BitConverter.ToUInt16(file, itemOffset + 4);
            return item;
        }
        ...
        public static MNU_ShopChangeTask ReadMNU_ShopChangeTask(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.forcequit = file[itemOffset + 29];
            item.IraCraftIndex = BitConverter.ToUInt16(file, itemOffset + 30);
            return item;
        }
        ...
        public static MNU_Stream_Ira_Npc ReadMNU_Stream_Ira_Npc(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_Stream_Ira_Npc();
            item.Id = itemId;
            item.filename = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset));
            item.filename_2nd = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 4));
            item.filename_3rd = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 8));
            return item;
        }
        ...
        public static MNU_Tutorial ReadMNU_Tutorial(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.start_id = file[itemOffset + 4];
            item.param1 = BitConverter.ToUInt32(file, itemOffset + 5);
            return item;
        }

        public static MNU_Tutorial_Chbtl ReadMNU_Tutorial_Chbtl(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_Tutorial_Chbtl();
            item.Id = itemId;
            item.title = BitConverter.ToUInt16(file, itemOffset);
            item.condition = BitConverter.ToUInt16(file, itemOffset + 2);
            item.bg_type = file[itemOffset + 4];
            item.use_telop = file[itemOffset + 5];
            item.use_hud_time = file[itemOffset + 6];
            item.use_hud_cube = file[itemOffset + 7];
            item.window_y1 = BitConverter.ToInt16(file, itemOffset + 8);
            item.message1 = BitConverter.ToUInt16(file, itemOffset + 10);
            item.window_y2 = BitConverter.ToInt16(file, itemOffset + 12);
            item.message2 = BitConverter.ToUInt16(file, itemOffset + 14);
            item.window_y3 = BitConverter.ToInt16(file, itemOffset + 16);
            item.message3 = BitConverter.ToUInt16(file, itemOffset + 18);
            return item;
        }

        public static MNU_Tutorial_Ira ReadMNU_Tutorial_Ira(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_Tutorial_Ira();
            item.Id = itemId;
            item.script_file = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset));
            item.start_id = file[itemOffset + 4];
            item.param1 = BitConverter.ToUInt32(file, itemOffset + 5);
            item.param2 = file[itemOffset + 9];
            item.HpRatio = file[itemOffset + 10];
            return item;
        }

        public static MNU_Tutorial_Tips ReadMNU_Tutorial_Tips(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new MNU_Tutorial_Tips();
            item.Id = itemId;
            item.title = BitConverter.ToUInt16(file, itemOffset);
            item.condition = BitConverter.ToUInt16(file, itemOffset + 2);
            item.page = file[itemOffset + 4];
            item.bg_type = file[itemOffset + 5];
            item.window_y1 = BitConverter.ToInt16(file, itemOffset + 6);
            item.message1 = BitConverter.ToUInt16(file, itemOffset + 8);
            item.window_y2 = BitConverter.ToInt16(file, itemOffset + 10);
        ...
        public static RSC_BgmList ReadRSC_BgmList(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new RSC_BgmList();
            item.Id = itemId;
            item.filename = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset));
            item.NoExchange = file[itemOffset + 4];
            return item;
        }
        ...
        public static RSC_En ReadRSC_En(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.ExtraParts5 = file[itemOffset + 140];
            item.ExtraParts6 = file[itemOffset + 141];
            item.DeadSeNum = file[itemOffset + 142];
        ...
        public static RSC_NpcList ReadRSC_NpcList(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.AreaNumber1 = BitConverter.ToUInt16(file, itemOffset + 54);
            item.Condition1 = BitConverter.ToUInt16(file, itemOffset + 56);
            item.MSGID2 = BitConverter.ToUInt16(file, itemOffset + 58);
            item.AreaNumber2 = BitConverter.ToUInt16(file, itemOffset + 60);
            item.Condition2 = BitConverter.ToUInt16(file, itemOffset + 62);
            item.MSGID3 = BitConverter.ToUInt16(file, itemOffset + 64);
            item.AreaNumber3 = BitConverter.ToUInt16(file, itemOffset + 66);
            item.result = BitConverter.ToUInt16(file, itemOffset + 68);
            return item;
        }
        ...
        public static RSC_PcWpnMount ReadRSC_PcWpnMount(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.Wpn35rIn = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 424));
            item.Wpn35rOut = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 428));
            item.Wpn35lIn = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 432));
            item.Wpn35lOut = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 436));
            item.Wpn36rIn = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 440));
            item.Wpn36rOut = Stuff.GetUTF8Z(file, tableOffset + BitConverter.ToInt32(file, itemOffset + 444));
            return item;
        }
        ...
        public static Vo_Battle_Blade ReadVo_Battle_Blade(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            ...
            item.RepBuddy = (item.Flag & 1) != 0;
            item.LotNum = (item.Flag & 2) != 0;
            item.NoOverwrite = (item.Flag & 4) != 0;
            item.Dead = (item.Flag & 8) != 0;
            item.NoDir = (item.Flag & 16) != 0;
            item.NoChain = (item.Flag & 32) != 0;
            item.NoReplyOK = (item.Flag & 64) != 0;
            item.SeriousOff = (item.Flag & 128) != 0;
            return item;
        }
        ...
        public static Vo_WinSpIra ReadVo_WinSpIra(byte[] file, int itemId, int itemOffset, int tableOffset)
        {
            var item = new Vo_WinSpIra();
            item.Id = itemId;
            item.FLD_CondID = BitConverter.ToUInt16(file, itemOffset);
            item.NeedChrID = BitConverter.ToUInt16(file, itemOffset + 2);
            for (int i = 0, offset = itemOffset + 4; i < 5; i++, offset += 2)
            {
                item.ChrID[i] = BitConverter.ToUInt16(file, offset);
            }
            for (int i = 0, offset = itemOffset + 14; i < 5; i++, offset += 4)
            {
                item.Voice[i] = BitConverter.ToUInt32(file, offset);
            }
            for (int i = 0, offset = itemOffset + 34; i < 5; i++, offset += 2)
            {
                item.Timer[i] = BitConverter.ToUInt16(file, offset);
            }
            return item;
        ...
        public static void SetReferences(BdatCollection tables)
        {
            ...
            foreach (BTL_Arts_Bl item in tables.BTL_Arts_Bl.Items)
            {
                ...
                item._BulletEffID = tables.BTL_BulletEffect.GetItemOrNull(item.BulletEffID);
            ...
            foreach (BTL_SpBtl item in tables.BTL_SpBtl.Items)
            {
                item._ArrangeID = tables.CHR_EnArrange.GetItemOrNull(item.ArrangeID);
                item._Gun = tables.CHR_EnArrange.GetItemOrNull(item.Gun);
                item._Lance = tables.CHR_EnArrange.GetItemOrNull(item.Lance);
            }

            foreach (BTL_Summon item in tables.BTL_Summon.Items)
            {
                for (int i = 0; i < 3; i++)
                {
                    item._EnemyID[i] = tables.CHR_EnArrange.GetItemOrNull(item.EnemyID[i]);
                }
            }
            ...
            foreach (CHR_Bl item in tables.CHR_Bl.Items)
            {
                ...
                item._PrivateWpnL = tables.RSC_PcWpn.GetItemOrNull(item.PrivateWpnL);
                item._PrivateWpnL_Driver = tables.RSC_PcWpn.GetItemOrNull(item.PrivateWpnL_Driver);
                item._PrivateWpnR = tables.RSC_PcWpn.GetItemOrNull(item.PrivateWpnR);
                item._PrivateWpnR_Driver = tables.RSC_PcWpn.GetItemOrNull(item.PrivateWpnR_Driver);
                item._QuestRace = tables.MNU_Msg_Race.GetItemOrNull(item.QuestRace);
            ...
            foreach (CHR_EnArrange item in tables.CHR_EnArrange.Items)
            {
                ...
                item._BladeAtr = tables.MNU_Msg_Attr.GetItemOrNull(item.BladeAtr + 1);
            ...
            foreach (MNU_txt item in tables.dlc301_list_txt.Items)
            {
                item._text_id = tables.menu_ms.GetItemOrNull(item.text_id);
            }
            ...
            foreach (MNU_txt item in tables.dlc303_menu_txt.Items)
            {
                item._text_id = tables.menu_ms.GetItemOrNull(item.text_id);
            }
            ...
            foreach (MNU_txt item in tables.dlc305_tips_txt.Items)
            {
                item._text_id = tables.menu_ms.GetItemOrNull(item.text_id);
            }
            ...
            foreach (FacialConfig item in tables.EVT_facialTemplate_NP75000002.Items)
            {
                item._brow_type = tables.EVT_browtype.GetItemOrNull(item.brow_type);
                item._eye_type = tables.EVT_eyetype.GetItemOrNull(item.eye_type);
                item._lip_type = tables.EVT_liptype.GetItemOrNull(item.lip_type);
            ...
            {
                item._Condition = tables.FLD_ConditionList.GetItemOrNull(item.Condition);
                item._txtID = tables.fld_helpms.GetItemOrNull(item.txtID);
            }
            ...
            {
                item._Category = (PlaceCategory)item.Category;
                item._MapID = tables.FLD_maplist.GetItemOrNull(item.MapID);
            }
            ...
            foreach (ITM_PcWpnChip item in tables.ITM_PcWpnChip.Items)
            {
                ...
                item._CreateWpn35 = tables.ITM_PcWpn.GetItemOrNull(item.CreateWpn35);
                item._CreateWpn36 = tables.ITM_PcWpn.GetItemOrNull(item.CreateWpn36);
            ...
            foreach (ma02a_FLD_LandmarkPop item in tables.ma02a_FLD_LandmarkPop.Items)
            {
                ...
                item._menuMapImage = tables.MNU_MapInfo.GetItemOrNull(item.menuMapImage);
                item._MSGID = tables.fld_landmark.GetItemOrNull(item.MSGID);
                item._stoff_cndID = tables.FLD_ConditionList.GetItemOrNull(item.stoff_cndID);
            }
            ...
            foreach (ma40a_FLD_EnemyPop item in tables.ma40a_FLD_EnemyPop.Items)
            {
                item._Condition = tables.FLD_ConditionList.GetItemOrNull(item.Condition);
                item._ene1ID = tables.CHR_EnArrange.GetItemOrNull(item.ene1ID);
                item._ene2ID = tables.CHR_EnArrange.GetItemOrNull(item.ene2ID);
            ...
            foreach (ma40a_FLD_NpcPop item in tables.ma40a_FLD_NpcPop.Items)
            {
                item._Condition = tables.FLD_ConditionList.GetItemOrNull(item.Condition);
                item._FSID1 = tables.FLD_FieldSkillSetting.GetItemOrNull(item.FSID1);
                item._FSID2 = tables.FLD_FieldSkillSetting.GetItemOrNull(item.FSID2);
            ...
            foreach (ma05c_FLD_EnemyPop item in tables.ma41a_FLD_EnemyPop.Items)
            {
                item._Condition = tables.FLD_ConditionList.GetItemOrNull(item.Condition);
                item._ene1ID = tables.CHR_EnArrange.GetItemOrNull(item.ene1ID);
                item._ene2ID = tables.CHR_EnArrange.GetItemOrNull(item.ene2ID);
            ...
            foreach (ma40a_FLD_NpcPop item in tables.ma41a_FLD_NpcPop.Items)
            {
                item._Condition = tables.FLD_ConditionList.GetItemOrNull(item.Condition);
                item._FSID1 = tables.FLD_FieldSkillSetting.GetItemOrNull(item.FSID1);
                item._FSID2 = tables.FLD_FieldSkillSetting.GetItemOrNull(item.FSID2);
            ...
            foreach (ma41a_FLD_TboxPop item in tables.ma41a_FLD_TboxPop.Items)
            {
                item._Condition = tables.FLD_ConditionList.GetItemOrNull(item.Condition);
                item._FSID = tables.FLD_FieldSkillSetting.GetItemOrNull(item.FSID);
                item._FSID2 = tables.FLD_FieldSkillSetting.GetItemOrNull(item.FSID2);
            ...
            foreach (MNU_DriverInfo item in tables.MNU_DriverInfo.Items)
            {
            ...
            foreach (MNU_txt item in tables.mnu106_named_dialog_txt.Items)
            {
                item._text_id = tables.menu_ms.GetItemOrNull(item.text_id);
            }

            foreach (MNU_txt item in tables.mnu107_named_list_txt.Items)
            {
                item._text_id = tables.menu_ms.GetItemOrNull(item.text_id);
            }

            foreach (MNU_txt item in tables.mnu108_btl_time_txt.Items)
            {
                item._text_id = tables.menu_ms.GetItemOrNull(item.text_id);
            }
            ...
            foreach (RSC_En item in tables.RSC_En.Items)
            {
                ...
                item._WeaponNum1 = tables.BTL_Wpn_En.GetItemOrNull(item.WeaponNum1);
                item._WeaponNum2 = tables.BTL_Wpn_En.GetItemOrNull(item.WeaponNum2);
                item._WeaponNum3 = tables.BTL_Wpn_En.GetItemOrNull(item.WeaponNum3);
                item._WeaponNum4 = tables.BTL_Wpn_En.GetItemOrNull(item.WeaponNum4);
                item._WeaponNum5 = tables.BTL_Wpn_En.GetItemOrNull(item.WeaponNum5);
            }
